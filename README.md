...
## Условия
1. Используйте этот [API](https://app.swaggerhub.com/apis/IVANKOVALENKOWORK/backend-bootcamp/1.0.0).
...
*Они не являются обязательными, но дадут вам преимущество перед другими кандидатами.*
